...
# --- Model Training Section (Random Forest Classifier) ---
...
if generated_data_file: #
    ...
    RFC_param_grid = {
        ...
        'min_samples_leaf': [2, 4, 6], # The minimum number of samples required to be at a leaf node
        'bootstrap': [True], # Whether bootstrap samples are used when building trees
        'class_weight': ['balanced'], # Weights associated with classes
        'criterion': ['entropy', 'log_loss'] # The function to measure the quality of a split
    }
    ...
    grid_search = GridSearchCV(
        estimator=RandomForestClassifier(random_state=42), # Instantiate RandomForestClassifier with random state
    ...
    # Write model training results to a specific file for Random Forest
    with open('out_result_Nature_GWAS_RFC_Kinship_endadta.txt', 'a') as file:
        # Output best parameters
        print(f"Nature_GWAS_RFC_Kinship_Best_parameters: {best_params}", file=file)
