...
print(f"Total valid parameter combinations: {len(LR_param_grid)}")
...
def obtain_best_LR_res(LR_results, percentile, output_file="KL_LR_model_detailed_results_by_Threshold.txt"):
    LR_acc_all = []
...
acc_LR_all = obtain_best_LR_res(LR_results, kl_percentile)
