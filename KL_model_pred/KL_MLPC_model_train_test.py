...
def obtain_best_MLPC_res(MLPC_results, percentile, output_file="KL_MLPC_model_detailed_results_by_Threshold.txt"):
    MLPC_acc_all = []
...
acc_MLPC_all = obtain_best_MLPC_res(MLPC_results, kl_percentile)
