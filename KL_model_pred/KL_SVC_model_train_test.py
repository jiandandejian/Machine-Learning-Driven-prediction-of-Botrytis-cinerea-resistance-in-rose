...
def obtain_best_SVC_res(SVC_results, percentile, output_file="KL_SVC_model_detailed_results_by_Threshold.txt"):
    SVC_acc_all = []
...
acc_SVC_all = obtain_best_SVC_res(SVC_results, kl_percentile)
