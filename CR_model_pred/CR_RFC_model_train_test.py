...
def obtain_best_RFC_res(RFC_results, percentile, output_file="CR_RFC_model_detailed_results_by_Threshold.txt"):
    RFC_acc_all = []
...
acc_RFC_all = obtain_best_RFC_res(RFC_results, CR_percentile)
