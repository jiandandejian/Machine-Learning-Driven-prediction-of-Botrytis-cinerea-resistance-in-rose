...
def obtain_best_LGBMC_res(LGBMC_results, percentile, output_file="CR_LGBMC_model_detailed_results_by_Threshold.txt"):
    LGBMC_acc_all = []
...
acc_LGBMC_all = obtain_best_LGBMC_res(LGBMC_results, CR_percentile)
