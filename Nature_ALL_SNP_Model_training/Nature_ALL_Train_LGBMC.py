...
# =============================================================
# This script applies LGBMClassifier to predict rose
...
data_dir = './'
file_name = 'nature_all_SNP_RS.tsv'
...
# Cleaned LightGBM hyperparameter grid (no warning conflicts)
LGBMC_param_grid = {
...
# Write output
with open('out_result_Nature_ALL_LGBMC_endadta.txt', 'a') as file:
    print(f"Nature_ALL_LGBMC_Best_parameters: {best_params}", file=file)
