...
# =============================================================
# This script applies Support Vector Classifier to predict rose
...
# Write output
with open('out_result_Nature_ALL_SVC_endadta.txt', 'a') as file:
    # Output best parameters
    print(f"Nature_ALL_SVC_Best_parameters: {best_params}", file=file)
